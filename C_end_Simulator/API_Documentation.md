...
7. [接口列表 — vx 微信端（新增）](#7-接口列表--vx-微信端新增)
   ...
   - 7.3 [当前用户信息 — GET /api/v1/me](#73-当前用户信息--get-apiv1me)
   - 7.4 [宠物状态快照 — GET /api/v1/pets/{pet_id}/summary](#74-宠物状态快照--get-apiv1petspet_idsummary)
   - 7.5 [最新呼吸采样 — GET /api/v1/pets/{pet_id}/respiration/latest](#75-最新呼吸采样--get-apiv1petspet_idrespirationlatest)
   - 7.6 [呼吸频率序列 — GET /api/v1/pets/{pet_id}/respiration/series](#76-呼吸频率序列--get-apiv1petspet_idrespirationseries)
   - 7.7 [最新心率采样 — GET /api/v1/pets/{pet_id}/heart-rate/latest](#77-最新心率采样--get-apiv1petspet_idheart-ratelatest)
   - 7.8 [心率序列 — GET /api/v1/pets/{pet_id}/heart-rate/series](#78-心率序列--get-apiv1petspet_idheart-rateseries)
   - 7.9 [事件列表 — GET /api/v1/pets/{pet_id}/events](#79-事件列表--get-apiv1petspet_idevents)
8. [消息队列通道（RabbitMQ）](#8-消息队列通道rabbitmq)
9. [存储后端](#9-存储后端)
10. [错误码汇总](#10-错误码汇总)
11. [部署与环境变量](#11-部署与环境变量)
12. [请求示例（cURL）](#12-请求示例curl)
13. [vx 端集成指南](#13-vx-端集成指南)
...
### 7.4 宠物状态快照 — `GET /api/v1/pets/{pet_id}/summary`
...
### 7.5 最新呼吸采样 — `GET /api/v1/pets/{pet_id}/respiration/latest`
...
### 7.6 呼吸频率序列 — `GET /api/v1/pets/{pet_id}/respiration/series`
...
### 7.7 最新心率采样 — `GET /api/v1/pets/{pet_id}/heart-rate/latest`
...
### 7.8 心率序列 — `GET /api/v1/pets/{pet_id}/heart-rate/series`
...
### 7.9 事件列表 — `GET /api/v1/pets/{pet_id}/events`
